const CACHE='nihon-loop-v12';
const CORE=['./','./index.html','./styles.css?v=12','./lesson-data.js?v=12','./curriculum-data.js?v=12','./app.js?v=12','./manifest.webmanifest','./icon.svg','./mascot.png'];
